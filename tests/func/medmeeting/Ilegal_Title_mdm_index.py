...
# pass number
pass_num = 0
file = open("Ilegal_Title_mdm_index.txt", "w")
#Scenario:
...
with open('Ilegal_Title_mdm_index.csv', 'w',newline='') as csv_file:
...
while True:
    ...
    if contain_en:
        ...
        fail_num += 1
        with open('Ilegal_Title_mdm_index.csv', 'a+', newline='') as csv_file:
            csv_writer = csv.writer(csv_file)
