...
# pass number
pass_num = 0
file = open("Ilegal_report_time_mdm_detail.txt", "w")
#Scenario:
...
with open('Ilegal_report_time_mdm_detail.csv', 'w', newline='') as csv_file:
...
while True:
    ...
    try:
        ...
        if contain_time:
            ...
            fail_num += 1
            with open('Ilegal_report_time_mdm_detail.csv', 'a+', newline='') as csv_file:
                csv_writer = csv.writer(csv_file)
