...
n = 1
# Case rsult storage
file = open("Ilegal_Asso_Name_man_ass.txt", "w")
####################################################################
#Scenario:
...
with open('Ilegal_Asso_Name_man_ass.csv', 'w', newline='') as csv_file:
...
while True:
    ...
    namecheck = en_cn_Check()
    try:
        contain_Asso_Name = namecheck.en_cn_length_check(row[2],6)
