...
pass_num = 0
# log preparation
file = open("Start_Time_format_man_event.txt", "w")
#Scenario:
...
with open('Start_Time_format_man_event.csv', 'w', newline='') as csv_file:
...
while True:
    ...
    try:
        ...
        if Fm_year and Fm_month and Fm_day:
            ...
            fail_num += 1
            with open('Start_Time_format_man_event.csv', 'a+', newline='') as csv_file:
                csv_writer = csv.writer(csv_file)
