...
n = 1
# Case rsult storage
file = open("Ilegal_Origin_Title_man_event.txt", "w")
####################################################################
#Scenario:
...
with open('Ilegal_Origin_Title_man_event.csv', 'w', newline='') as csv_file:
...
while True:
    ...
    try:
        ...
        if Origin_Title:
            ...
            fail_num += 1
            with open('Ilegal_Origin_Title_man_event.csv', 'a+', newline='') as csv_file:
                csv_writer = csv.writer(csv_file)
